...
#   ---AAS degree in Information TechnologyL
#       ---required courses
...
def display_network_courses():
    ...
    out.write("\n   Students choose 3 technical elective course")
    out.write(dash_line)
...
def process_info_courses():
    ...
    tot_info = num_net_req + num_info_elect
...
def display_info_courses():
    ...
    out.write("\nTotal number of Information Technology courses: " + str(tot_info))
    out.write(dash_line)
...
def process_courses_in_both():
    ...
    out.write(dash_line)
    out.write("\nElectives courses in both programs:")
    num = 1
